        ...
        foreach ($this->chatTService->getAll() as $chatT) {
            try {
                $this->telegramApiService->sendMessage(
                    $chatT,
                    "With a heavy and even voice, I say now: it's time to say goodbye. Our beloved @TGPTalkBot, who was always our beacon in the world of information and technology, is prepared to leave us forever. 
